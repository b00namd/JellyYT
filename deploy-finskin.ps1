# Deploy script fuer FinSkin - baut das Plugin und kopiert es direkt auf den Jellyfin-Server.
...
param(
    ...
    [string]$PluginDir  = "/home/henny/docker/cloud/config/data/plugins/FinSkin_$Version",
...
$PublishDir = Join-Path $PSScriptRoot "dist\publish-finskin-deploy"

# --- 1. Build ---
Write-Host "Baue FinSkin..." -ForegroundColor Cyan
