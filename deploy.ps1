# Deploy script - baut das Plugin und kopiert es direkt auf den Jellyfin-Server.
...
param(
    ...
    [string]$PluginDir  = "/home/henny/docker/cloud/config/data/plugins/JellyTube_$Version",
